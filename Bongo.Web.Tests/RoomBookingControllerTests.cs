...
namespace Bongo.Web
{
    ...
    public class RoomBookingControllerTests
    {
        ...
        [Test]
        public void BookRoomCheck_NotSuccessful_NotRoomCode()
        {
            ...
            ViewResult viewResult = result as ViewResult;
            ClassicAssert.AreEqual("No Study Room availabe for selected date", viewResult.ViewData["Error"]);
        }
        ...
        public void BookRoomCheck_Successful_SuccessCodeAndRedirect()
        {
            ...
            ClassicAssert.AreEqual("Johna", actionResult.RouteValues["FirstName"]);
